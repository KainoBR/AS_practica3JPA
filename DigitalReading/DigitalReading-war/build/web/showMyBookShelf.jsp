        ...
        <table class="table table-hover">
            ...
            <c:forEach var="bookshelfItem" items="${biblioteca}">
                ...
                <c:url var="removeLink" value="FrontController">
                    ...
                    <c:param name="bookID" value="${bookshelfItem.idbook.id}"></c:param>

                </c:url>

                <tr>

                    <td> ${bookshelfItem.idbook.title}</td>
                    <td> ${bookshelfItem.idbook.author}</td>
                    <td> ${bookshelfItem.idbook.genre}</td>
                    <td> ${bookshelfItem.idbook.sellingdate}</td>
                    <td> ${bookshelfItem.idbook.price}</td>
                    <td> 
