...
<c:if test="${carrito.isEmpty()==false}">
    ...
    <ul class="list-group mb-3">
        ...
        <c:forEach var="cartItem" items="${carrito.getCart()}">
            ...
            <c:url var="addToWhishlistLink" value="FrontController">

                <c:param name="command" value="addBookToWhishList"></c:param>
                <c:param name="bookID" value="${cartItem.id}"></c:param>
            ...
            <li class="list-group-item d-flex justify-content-between lh-condensed">
                <div>
                    ...
                    <a href="${addToWhishlistLink}" class="px-3"style="color: green">add to whishlist</a>
                </div>
