    ...
    <div class="row py-3">
        <div class="col-sm-3"><!--left col-->
            ...
            <ul class="list-group mb-6">
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <span><strong>is Admin</strong></span> ${user.getAdmin()==1}
                </li>
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <span><strong>Book</strong></span> ${numBooks}
                </li>
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <strong>Comments</strong >${numComments}
                </li>
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <span><strong>Likes</strong></span>${numLikes}
                </li>
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    ...
                    <div class="tab-pane active">
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                ...
                                <input type="text" class="form-control" name="username" value="${user.getUsername().getFirstname()}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label><h4>Last name</h4></label>
                                <input type="text" class="form-control" name="lastname" value="${user.getUsername().getLastname()}" required>
                            </div>
                        </div>
