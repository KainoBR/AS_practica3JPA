...
<c:forEach var="libro" items="${catalogo}">
    <c:if test="${libro.getComments().isEmpty() == false}">

        <div class="container py-3">
            <div class="row">
                <div class="col-md-3 bg-dark text-center py-3">
                    <div class="card mb-2 shadow-sm py-3">
                        <div class="card-header">${libro.title} </div>
                        <div class="card-body py-3">
                            <img class="card-img-top img-responsive" src="${libro.getCoverpage()}" alt="Card image cap" width="72" height="250">
                        </div>
                    </div>
                </div>
                <div class="col-md-8 bg-light py-3">
                    <form action="FrontController" id="updateCommentForm">
                        ...
                        <c:forEach var="comentario" items="${libro.getComments()}">
                            ...
                            <div class="row py-3">
                                <div class="col-md-8 md-form">
                                    <!-- <textarea class="md-textarea form-control" rows="3" name="comment"  form="updateCommentForm"></textarea> -->
                                    <input type="text" required class="md-textarea form-control" name="comment"  value="${comentario}" form="updateCommentForm" />
                                </div>
