...
<!-- Modal add Timer -->
<div class="modal fade" id="addTimer" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: indianred">
                <h5 class="modal-title text-center" style="color: white">new Timer</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="FrontController">
                <input type="hidden" name="command" value="addUserTimer">
                <div class="modal-body" style="background-color: GhostWhite">
                    <label>Introduce miliseconds: </label>
                    <input type="text" name="miliseconds"/>
                    <label> loop: </label>
...
<div class="modal fade" id="insertCommentForm" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
