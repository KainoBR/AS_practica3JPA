    ...
    <div class="row">
        ...
        <div class="col-md-3 bg-dark text-center">
            <div class="card mb-2 shadow-sm ">
                ...
                <div class="card-body">
                    <img class="card-img-top img-responsive" src="${libro.getCoverpage()}" alt="Card image cap" width="72px" height="250px">
        ...
        <div class="col-md-8 bg-light py-3">
            ...
            <div>
                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#insertCommentForm">comment</button> 
            </div>
