        ...
        <div class="card-body">
            <form action="FrontController">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="fTitle" name="title" placeholder="Book title" class="form-control" required> 
                </div>

                <div class="form-group">
                    <label for="fAuthor">Author</label>
                    <input type="text" id="fAuthor" name="author" placeholder="Book author" class="form-control" required>
                </div>

                <div class="form-group">
                    <label for="fGenre">Genre</label>
                    <input type="text" id="fGenre" name="genre" placeholder="Book genre" class="form-control" required>
                </div>

                <div class="form-group">
                    <label for="fSellingDate">SellingDate</label>
                    <input type="text" id="fSellingDate" name="sellingDate" placeholder="Book selling date" class="form-control" required>
                </div>

                <div class="form-group">
                    <label for="fPrice">Price</label>
                    <input type="text" id="fPrice" name="price" placeholder="Book price" class="form-control" required>
                </div>
